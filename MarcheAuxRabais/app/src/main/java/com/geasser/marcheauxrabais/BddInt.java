...
public class BddInt extends SQLiteOpenHelper {
    ...
    private static String CREATE_TABLE_HISTACHAT =
            "CREATE TABLE IF NOT EXISTS "+"histachat"+" ("+
                    "ID"+" INTEGER PRIMARY KEY AUTOINCREMENT, "+
                    "Utilisateur"+" INT NOT NULL, "+
                    "DATE"+" TEXT NOT NULL, "+
                    "Rabais"+" INTEGER NOT NULL);";
    private static String CREATE_TABLE_HISTORIQUE =
    ...
    private static String CREATE_TABLE_PROFIL =
    ...
    private static String CREATE_TABLE_RABAIS =
            "CREATE TABLE IF NOT EXISTS "+"rabais"+" ("+
                    ...
                    "Image"+" TEXT NOT NULL, "+
                    "Lvl"+" INTEGER); ";
    private static String CREATE_TABLE_SECTEURS =
            "CREATE TABLE IF NOT EXISTS "+"secteurs"+" ("+
                    "ID"+" INTEGER PRIMARY KEY AUTOINCREMENT, "+
                    "Nom"+" TEXT NOT NULL, "+
                    "Image"+" TEXT);";
    private static String CREATE_TABLE_SUCCES =
